...
import imageX1 from "./normals-map-x1.png?url";
import imageX2 from "./normals-map-x2.png?url";
    ...
    const drawNormalsMap = gl
        .command(PrimitivesType.TriangleStrip, {
            ...
            fragment: ({ uNormalsMap, vPosition, uLightPosition }) => {
                const lightDirection = uLightPosition
                    .sub(vPosition.mul(2).sub(1).cat(0))
                    .normalize()
                    .memMQ();
